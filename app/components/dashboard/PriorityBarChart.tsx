...
export default function PriorityBarChart({
  ...
  return (
    <div className="rounded-xl border border-zinc-700 bg-zinc-800 p-5">
      ...
      <div className="mt-4 flex items-end justify-around gap-3" style={{ height: 140 }}>
        {data.map((bucket) => {
          ...
          return (
            <div key={bucket.label} className="flex flex-1 flex-col items-center gap-1">
              ...
              <div className="relative w-full overflow-hidden rounded-t-md bg-zinc-700" style={{ height: 100 }}>
                <div
